...
class DTN(object):
    ...
    def build_model(self):
        ...
        if self.mode == 'pretrain':
            ...
            # self.d_train_op_src = tf.train.AdamOptimizer(self.learning_rate).minimize(self.d_loss_src,
            #                                                                           var_list=d_vars)
            # self.g_train_op_src = tf.train.AdamOptimizer(self.learning_rate).minimize(self.g_loss_src,
            #                                                                           var_list=g_vars)
