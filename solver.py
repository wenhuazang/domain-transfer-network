...
class Solver(object):
    ...
    def __init__(self, model, batch_size=100, pretrain_iter=20000, train_iter=2000, sample_iter=100,
                 ...
                 model_save_path='model_dtn', pretrained_model='model/svhn_model-20000', test_model='model_dtn/dtn-1800'):
    ...
    def train(self):
        ...
        with tf.Session(config=self.config) as sess:
            ...
            for step in range(self.train_iter+1):
                ...
                # if (step+1) % 10 == 0:
                #     dl, gl, fl = sess.run([model.d_loss_src, model.g_loss_src, model.f_loss_src], feed_dict)
                #     # summary_writer.add_summary(summary, step)
                ...
                if (step+1) % 200 == 0:
                    ...
                    print ('model_dtn/dtn-%d saved' %(step+1))
    ...
    def load(self, checkpoint_dir='model_dtn/'):
